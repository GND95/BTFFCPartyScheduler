    ...
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (ZipFile zip = new ZipFile(""))
            {
                ...
                zip.AddDirectory("C:/Program Files/BTFFCPartyProgram/test", "PartyData");   //this is where the files that are put into the new zip file come from         
                zip.Save("C:/Documents and Settings/Garrett/Desktop/BackupPartyInformation.zip"); //this is where the zip file saves to
                ...
                smtp.Credentials = nc;
                smtp.EnableSsl = true;
                Attachment attachment = new Attachment("C:/Documents and Settings/Garrett/Desktop/BackupPartyInformation.zip"); //attaching the zip data file to email
